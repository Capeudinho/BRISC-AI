...
Downloads the BRISC 2025 dataset from [`briscdataset/brisc2025` in Kaggle](https://www.kaggle.com/datasets/briscdataset/brisc2025), reorganizes it into the `archive` directory, and formats it into the `data` directory.
...
Fine-tunes a pretrained U-Net from [`mateuszbuda/brain-segmentation-pytorch` in GitHub](https://github.com/mateuszbuda/brain-segmentation-pytorch) using the segmentation dataset. The resulting fine-tuned model weights are saved in the `weights/` directory.
